...
const I18NSERVICE_PROVIDES = [{ provide: ALAIN_I18N_TOKEN, useClass: LocalizationExtendService, multi: false }];
// #region
...
import { TranslateVNextPipe } from './shared/i18n/translate.pipe';
