    ...
    <layout-default [options]="options" [asideUser]="asideUserTpl" [content]="contentTpl">
      ...
      <ng-template #asideUserTpl>
        ...
        <nz-dropdown-menu #userMenu="nzDropdownMenu">
          <ul nz-menu>
            <li nz-menu-item routerLink="/pro/account/center">{{ 'Menu:Account.Center' | _translate }}</li>
            <li nz-menu-item routerLink="/pro/account/settings">{{ 'Menu:Account.Settings' | _translate }}</li>
          </ul>
        </nz-dropdown-menu>
      </ng-template>
